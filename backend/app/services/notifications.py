...
# ---------------------------------------------------------------------------
# Standout picks (a correct call most of the field missed) — the thresholds the
# draw's standout chips use (routers/tournaments my-standouts). The emails and
# pushes that once announced them were retired in August and their code
# removed 2026-09-26.
# ---------------------------------------------------------------------------
