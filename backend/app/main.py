...
from app.routers import admin, app_push, auth, contact, discovery, h2h, leagues, passkeys, predictions, push, schedule, stream, tournaments
...
app.include_router(app_push.router)
