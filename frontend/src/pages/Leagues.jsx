...
export default function Leagues() {
  ...
  return (
    <div className="leagues-page">
      ...
      {/* Aligned to sit above the Draws card specifically — mirrors the same
          flex:1 + 300px column split used by .league-body-row below, so the
          right edge lines up with the Draws card's right edge, not the page's. */}
      {(canInvite || isOwner) && (
        <div className="league-header-actions-row">
          <div className="league-header-actions-spacer-draws">
          ...
          <div className="league-header-actions-spacer-members" />
        </div>
      )}
